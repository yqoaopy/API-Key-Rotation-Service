...
from app.api.v1.key_management import (
    router,
...
def test_get_api_key(
    mock_rate_limiter, mock_return_values, expected_status, expected_api_key
):
...
# 測試不同的服務請求
def test_get_api_key_for_different_services(
    mock_rate_limiter, service_type, expected_status, expected_api_key
):
